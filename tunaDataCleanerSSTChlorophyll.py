...
def checkLatLng(portLat, portLng, latList, lngList, listOfSST, listOfChlorophyll, decimalToCheck):

    latAfterCheckLat = []
    lngAfterCheckLat = []
    sstAfterCheck = []
    chlorophyllAfterCheck = []
    ...
    for i in range(len(latList)):
        ...
        if latList[i] <= (portLat-decimalToCheck) or latList[i] >= (portLat+decimalToCheck):
            ...
            sstAfterCheck.append(listOfSST[i])
            chlorophyllAfterCheck.append(listOfChlorophyll[i])
    ...
    return latAfterCheckLat, lngAfterCheckLat,sstAfterCheck,chlorophyllAfterCheck


def checkPort(portLat, portLong, listOfLat, listOfLng, listOfSST, listOfChlorophyll, decimalToCheck):
    ...
    return latChecked, lngChecked, sstChecked, chlorophyllChecked
...
cleanedFolderPath = "cleaned_data_11km_sst_chlorophyll"
